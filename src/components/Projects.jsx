      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-white/60 max-w-2xl mx-auto text-lg">
            A selection of my recent work across different industries and platforms
          </p>
        </div>
          ...
          {filteredProjects.map((project) => (
            ...
            >
              ...
              <div className="relative h-56 overflow-hidden">
                ...
                {/* Overlay on Hover */}
                <div className={`absolute inset-0 bg-imperial-blue-500/90 flex items-center justify-center gap-4 transition-all duration-300 ${hoveredProject === project.id ? 'opacity-100' : 'opacity-0'}`}>
                  <a
                    href={project.link}
                    target="_blank"
